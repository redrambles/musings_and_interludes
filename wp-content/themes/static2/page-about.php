                	...
                	<div class="thumbnails-pan">
                    	...
                    	<section class="col-xs-12 col-sm-4 col-md-4 col-lg-4 ">
                        	...
                        	<figure>
                            	...
                            	<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/about-images/about-image-1.jpg" class="img-responsive"/>
                        ...
                        <section class="col-xs-12 col-sm-4 col-md-4 col-lg-4 ">
                        	...
                        	<figure>
                            	...
                            	<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/about-images/about-image-2.jpg" class="img-responsive"/>
                        ...
                        <section class="col-xs-12 col-sm-4 col-md-4 col-lg-4 ">
                        	...
                        	<figure>
                            	...
                            	<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/about-images/about-image-3.jpg" class="img-responsive"/>
